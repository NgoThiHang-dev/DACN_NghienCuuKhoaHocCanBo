        ...
        <div class="content">
            <div class="container-fluid">
                        ...
                        <ol class="breadcrumb" style="float: right; font-size:15px;">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                <a style="text-decoration:none;font-weight:bold;"
                                    href="{{ asset('users/nghiencuu/khac/index') }}">
                                    NCKH
                                </a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                <a style="text-decoration:none; color:black"
                                    href="{{ asset('users/nghiencuu/khac/add') }}">
                                    Thêm mới
                                </a>
                            </li>
                        </ol>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <br>
                        <h3 class="title" style="color: green">Thêm đề hoạt động nghiên cứu mới</h3>
                    </div>
                    <div class="col-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Tên hoạt động nghiên cứu <i style="color: red">*</i></label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="DinhDang" id="">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Mô tả</label>
                                                <textarea class="form-control" name="TomTat" rows="9"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row g-3">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label class="form-label">Mã tác giả<i style="color: red">*</i></label>
                                                        <input type="text" class="form-control" name="MaGV" value="{{$user->MaGV}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label class="form-label">Họ tên tác giả<i style="color: red">*</i></label>
                                                        <input type="text" class="form-control" name="TenGV" value="{{$giangvien->TenGV}}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label class="form-label">Vai trò<i style="color: red">*</i></label>
                                            ...
                                            <div class="row g-2">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Ngày bắt đầu tham gia<i style="color: red">*</i></label>
                                                        <input type="date" class="form-control" name="NgayThamGia">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Ngày kết thúc tham gia<i style="color: red">*</i></label>
                                                        <input type="date" class="form-control" name="NgayKetThucTG">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Nơi tổ chức <i style="color: red">*</i></label>
                                                <input type="text" class="form-control" name="CoSoTC" id="">
                                            </div>
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" name="NgayNghiemThu">
                                                    </div>
