...
<body>
    ...
    <h2 style="text-align: center">DANH SÁCH CÁC HOẠT ĐỘNG NGHIÊN CỨU KHOA HỌC KHÁC</h2>
    ...
    <table border="0" align="center" cellpadding="5" style="border-collapse: collapse;">
        ...
        @foreach ($detai as $row)
            <tr style="background: #fff;">
                ...
                <td>
                    <span>{{ App\Models\DeTai::find($row->id_DeTai)->DinhDang }}</span>
                </td>
                <td>
                    <span>{{ App\Models\DeTai::find($row->id_DeTai)->CoSoTC }}</span>
                </td>
                <td>
