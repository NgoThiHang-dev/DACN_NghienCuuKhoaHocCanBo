        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <br>
                        <h3 class="title" style="color: green">Bài báo</h3>
                    </div>
                    <div class="col-12">
                                    ...
                                    <div class="row g-5">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="TenTapChi">
                                            </div>
                                            <div class="row g-2">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="Trang">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="TomTat" rows="8" placeholder="Tối đa 1000 ký tự"></textarea>
                                            </div>
