        ...
        <div class="content">
            <div class="container-fluid">
                        ...
                        <ol class="breadcrumb" style="float: right; font-size:15px;">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                <a style="text-decoration:none; color:black"
                                    href="{{ asset('users/nghiencuu/baibao/add') }}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <br>
                        <h3 class="title" style="color: green">Tác giả bài báo</h3>
                    </div>
                    @if (session('thongbao'))
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label">ID bài báo<i style="color: red">*</i></label>
                                                <input type="text" class="form-control" name="id_DeTai"
                                                    value="{{ $baibao->id_DeTai }}" readonly>
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="TenDeTai"
                                                    value="{{ $baibao->TenDeTai }}" readonly>
                                            </div>
                                            <div class="mb-3">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                {{--  <select class="form-select" name="VaiTro" disabled>
                                                    <?php
                                                    if ($tg_bb->VaiTro =="Tác giả chính")
                                                        echo '<option value="Tác giả chính" selected>Tác giả chính</option>
                                                        <option value="Đồng tác giả">Đồng tác giả</option>';
                                                    if ($tg_bb->VaiTro=="Đồng tác giả")
                                                        echo '<option value="Tác giả chính">Tác giả chính</option>
                                                        <option value="Đồng tác giả" selected>Đồng tác giả</option>';
                                                    if ($tg_bb->VaiTro=="")
                                                    echo '<option value="" selected>Chọn vai trò của tác giả</option>
                                                    <option value="Tác giả chính">Tác giả chính</option>
                                                    <option value="Đồng tác giả" selected>Đồng tác giả</option>';
                                                    ?>
                                                </select>  --}}
                                                <input type="text" class="form-control" name="VaiTro" value="{{$tg_bb->VaiTro}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label>Ngày bắt đầu tham gia<i style="color: red">*</i></label>
                                                <input type="date" class="form-control" name="NgayThamGia" value="{{$tg_bb->NgayThamGia}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label>Ngày kết thúc<i style="color: red">*</i></label>
                                                <input type="date" class="form-control" name="NgayKetThucTG" value="{{$tg_bb->NgayKetThucTG}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-2">
