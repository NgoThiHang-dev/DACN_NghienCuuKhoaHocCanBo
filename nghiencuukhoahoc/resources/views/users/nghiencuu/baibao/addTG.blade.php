                        ...
                        <form action="" method="post" style="width: 90%; margin: 0px auto; "
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="mb-3">
                                            {{--  <label class="form-label">Họ tên giảng viên<i
                                                    style="color: red">*</i></label>
                                            <input type="text" class="form-control"
                                                value="{{ $giangvien->TenGV }}" readonly>  --}}
                                            <label>Họ và tên tác giả<i style="color: red">*</i></label>
                                            <select class="form-select" name="MaGV">
                                                @foreach ($giangvien as $value)
                                                    <option value="{{$value->MaGV}}">
                                                        {{$value->TenGV}} - {{$value->MaGV}}
                                                    </option>;
                                                    @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="VaiTro">
                                                    <option value="">Chọn vai trò của tác giả</option>
