        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <br>
                        <h3 class="title" style="color: green">Sách, giáo trình, tài liệu giảng dạy</h3>
                    </div>
                    <div class="col-12">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="LoaiBienTap">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="TomTat" rows="8"></textarea>
                                            </div>
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="DinhDang">
