...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        @include('admin.partials.content-header', ['name'=>'Loại đề tài', 'key'=>'Thêm'])
        <!-- /.content-header -->
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label>ID loại đề tài <i style="color: red">*</i></label>
                                                        <input type="text" class="form-control" name="id_LoaiDeTai"
                                                            readonly>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label>Tên loại đề tài <i style="color: red">*</i></label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label>Đơn vị tính <i style="color: red">*</i></label>
                                                        <input type="text" class="form-control" name="DonViTinh">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label>Tiết quy đổi <i style="color: red">*</i></label>
