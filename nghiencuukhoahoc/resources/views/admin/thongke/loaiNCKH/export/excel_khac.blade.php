...
<body>
    ...
    <h2 style="text-align: center">DANH SÁCH CÁC HOẠT ĐỘNG NGHIÊN CỨU KHOA HỌC HỌC KỲ: {{ $hocky }} - NĂM HỌC: {{ $namhoc }}</h2>
    <h3><u>Tổng số bài:</u> 
    ...
    <table border="0" align="center" cellpadding="5" style="border-collapse: collapse; width:100%">
        <thead>
            <tr>
                ...
                <td style="text-align: center;">Năm thực hiện</td>
                <td style="text-align: center;">Nơi tổ chức</td>
                <td style="text-align: center;">Ngày hoàn thành</td>
                <td style="text-align: center;">Loại hoạt động</td>
