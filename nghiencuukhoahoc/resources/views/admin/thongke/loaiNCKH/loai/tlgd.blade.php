<div class="col-md-12">
    <div class="form-group mx-sm-3 mb-2" style="float: right;">
        <a href="{{asset('admin/thongke/theoloai/excel_tlgd')}}/{{ $_POST['HocKy'] }}/{{ $_POST['NamHoc'] }} " class="btn btn-success float-right"
        style="color:#fff">
...
<div class="col-md-12">
    <h3 style="color: green">Danh sách: Sách, giáo trình, tài liệu giảng dạy</h3>
</div>
<div class="col-md-12">
    <p> 
        <u>Tổng số bài:</u> 
    ...
    <table class="table table-hover table-bordered" style="background: #fff" cellspacing="0"
        ...
        <thead>
            <tr style="font-weight: bold;background:rgb(202, 201, 201)">
                ...
                <td style="text-align: center; width:18%" rowspan="2">Tên sách, giáo trình, TLGD</td>
