<div class="col-md-12">
    <div class="form-group mx-sm-3 mb-2" style="float: right;">
        <a href="{{asset('admin/thongke/theoloai/excel_all')}}/{{ $_POST['HocKy'] }}/{{ $_POST['NamHoc'] }} " class="btn btn-success float-right"
            style="color:#fff">
...
<div class="col-md-12">
    <h3 style="color: green">Danh sách các nghiên cứu khoa học</h3>
</div>
<div class="col-md-12">
    <p> 
        <u>Tổng số bài:</u> 
