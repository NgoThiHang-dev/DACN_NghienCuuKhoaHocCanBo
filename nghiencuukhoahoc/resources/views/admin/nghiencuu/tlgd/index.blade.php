            ...
            <div class="container-fluid">
                <div class="row">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" href="{{asset('admin/nghiencuu/tlgd/index')}}">Sách, giáo trình, tài liệu giảng dạy</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="row" style=" float: right;">
                    <div class="form-group mb-2" style="float: right;">
                        <a href="{{ asset('admin/nghiencuu/tlgd/add') }}" class="btn btn-success float-right">
                            <i class="bi bi-plus"></i>Thêm</a>
                    </div>
                    <div class="form-group mx-sm-3 mb-2">
                        <a href="{{ asset('admin/nghiencuu/tlgd/excel') }}" class="btn btn-success float-right">
                        ...
                        <table class="table table-hover table-bordered" style="background: #fff" cellspacing="0" cellpadding="5">
                            <thead>
                                <tr style="border: 1px solid #fff; font-weight:bold">
                                    ...
                                    <td style="text-align: center;width:5%" rowspan="2">Năm xuất bản</td>
                            ...
                            @foreach ($detai as $row)
                                <tr style="background: #fff">
                                    ...
                                    <td>
                                        ...
                                        @if ($dem==0)
                                        <a type="button" class="btn btn-link" href="{{ asset('admin/nghiencuu/tlgd/addTG') }}/{{ $row->id_DeTai }}">Thêm tác giả</a>
                                        @endif
                                        <span>
                                            ...
                                            <li style="font-size: 14px; color:gray">Giờ NCKH: {{$ma->SoTiet}}</li>
                                                <a style="float: right;" href="{{ asset('admin/nghiencuu/tlgd/deleteTG') }}/{{ $row->id_DeTai }}/{{ $ma->MaGV }}" >
                                                    <i class="bi bi-x-square-fill" style="color:red;"></i>
                                                </a>
                                                <a style="float: right; margin-right:10px;" href="{{ asset('admin/nghiencuu/tlgd/updateTG') }}/{{ $row->id_DeTai }}/{{ $ma->MaGV }}">
                                    ...
                                    <td style="text-align: center;">
                                        <a href="{{ asset('admin/nghiencuu/tlgd/update') }}/{{ $row->id_DeTai }}">
                                    ...
                                    <td style="text-align: center;">
                                        <a href="{{ asset('admin/nghiencuu/tlgd/delete') }}/{{ $row->id_DeTai }}">
