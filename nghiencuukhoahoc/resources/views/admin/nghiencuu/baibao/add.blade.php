...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        @include('admin.partials.content-header', ['name'=>'Bài báo nghiên cứu khoa học', 'key'=>'Thêm'])
        <!-- /.content-header -->
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row g-2">
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label">Tên tập trí <i style="color: red">*</i></label>
                                                    <input type="text" class="form-control" name="TenTapChi" id="">
                                                </div>
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control" name="id_LoaiDeTai">
                                                        <option value="" style="width: 450px; height:500px">Chọn Loại đề tài
                                                        </option>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="Trang" id="">
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3" style="float: right">
                                                            <a class="btn btn-danger them"
                                                                href="{{ asset('admin/nghiencuu/baibao/index') }}"
                                                                role="button">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16"
