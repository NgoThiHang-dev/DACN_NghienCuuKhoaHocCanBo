            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" href="{{asset('admin/nghiencuu/baibao/index')}}">Bài báo đăng trên các tạp chí khoa học</a>
                        </li>
                        <li class="nav-item">
            ...
            @endif
                <div class="row" style=" float: right;">
                    <div class="form-group mb-2" style="float: right;">
                        <a href="{{ asset('admin/nghiencuu/baibao/add') }}" class="btn btn-success float-right">
                            <i class="bi bi-plus"></i>Thêm bài báo mới</a>
                    </div>
                    <div class="form-group mx-sm-3 mb-2">
                        <a href="{{ asset('admin/nghiencuu/baibao/excel') }}" class="btn btn-success float-right">
                        ...
                        <table class="table table-hover table-bordered" style="background: #fff" cellspacing="0" cellpadding="5">
                            <thead>
                                <tr style="border: 1px solid #fff; font-weight:bold">
                                    <td style="text-align: center;width:5%" rowspan="2">ID</td>
                                    <td style="text-align: center; width:15%" rowspan="2">Tên đề tài</td>
                                    <td colspan="2" style="text-align: center;width:26%">Tác giả</td>
                                    <td style="text-align: center;width:10%" rowspan="2">Tình trạng</td>
                                    <td style="text-align: center;width:10%" rowspan="2">Năm xuất bản</td>
                                    <td style="text-align: center;width:10%" rowspan="2">Tên tạp chí</td>
                                    <td style="text-align: center;width:12%" rowspan="2">Tập tin đính kèm</td>
                                    <td style="text-align: center;width:5%" rowspan="2">Sửa</td>
                                    <td style="text-align: center;width:5%" rowspan="2">Xóa</td>
                                </tr>
                                <tr>
                            ...
                            @foreach ($detai as $row)
                                <tr style="background: #fff">
                                    ...
                                    <td>
                                        ...
                                        @if ($dem==0)
                                        <a type="button" class="btn btn-link" href="{{ asset('admin/nghiencuu/baibao/addTG') }}/{{ $row->id_DeTai }}">Thêm tác giả</a>
                                        @endif
                                        <span>
                                            ...
                                            <li style="font-size: 14px; color:gray">Giờ NCKH: {{$ma->SoTiet}}</li>
                                                <a style="float: right;" href="{{ asset('admin/nghiencuu/baibao/deleteTG') }}/{{ $row->id_DeTai }}/{{ $ma->MaGV }}" >
                                                    <i class="bi bi-x-square-fill" style="color:red;"></i>
                                                </a>
                                                <a style="float: right; margin-right:10px;" href="{{ asset('admin/nghiencuu/baibao/updateTG') }}/{{ $row->id_DeTai }}/{{ $ma->MaGV }}">
                                    ...
                                    <td><span>{{ $row->TenTapChi }}</span></td>
                                    <td>
                                        <span>
                                        <a href="{{asset('admin/nghiencuu/baibao/download')}}/{{ $row->TepDinhKem }}">{{ $row->TepDinhKem }}</a></span></td>
                                    <td style="text-align: center;">
                                        <a href="{{ asset('admin/nghiencuu/baibao/update') }}/{{ $row->id_DeTai }}">
                                    ...
                                    <td style="text-align: center;">
                                        <a href="{{ asset('admin/nghiencuu/baibao/delete') }}/{{ $row->id_DeTai }}">
